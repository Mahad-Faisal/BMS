/*
 * single_cell_battery_phaseC_backup.h
 *
...
#define single_cell_battery_phaseC_backup_M (single_cell_battery_phaseC_b_M)

/* Block signals (default storage) */
typedef struct {
  real_T OCV_LUT;                      /* '<Root>/OCV_LUT' */
  real_T R0_LUT;                       /* '<Root>/R0_LUT' */
  real_T I_pack_off;                   /* '<Root>/I_pack_off' */
  real_T I_pack;                       /* '<Root>/I_pack' */
  real_T Vp1_Integrator1;              /* '<Root>/Vp1_Integrator1' */
  real_T Vp2_Integrator;               /* '<Root>/Vp2_Integrator' */
  real_T V_cell_to_pack;               /* '<Root>/V_cell_to_pack' */
  real_T C1_LUT;                       /* '<Root>/C1_LUT' */
  real_T Product1;                     /* '<Root>/Product1' */
  real_T Divide;                       /* '<S1>/Divide' */
  real_T Gain;                         /* '<S1>/Gain' */
  real_T inv_Rcs;                      /* '<S1>/inv_Rcs' */
  real_T inv_Cc;                       /* '<S1>/inv_Cc' */
  real_T Vp1_dot;                      /* '<Root>/Vp1_dot' */
  real_T Vp2_feedback;                 /* '<Root>/Vp2_feedback' */
  real_T Vp2_dot;                      /* '<Root>/Vp2_dot' */
  real_T dSoC_per_step;                /* '<Root>/dSoC_per_step' */
  real_T Clock;                        /* '<Root>/Clock' */
} B_single_cell_battery_phaseC__T;
...
struct P_single_cell_battery_phaseC__T_ {
  ...
  real_T Np;                           /* Variable: Np
                                        * Referenced by: '<Root>/I_pack_to_cell'
                                        */
  real_T Ns;                           /* Variable: Ns
                                        * Referenced by: '<Root>/V_cell_to_pack'
                                        */
  ...
  real_T R0_2d_fix[36];                /* Variable: R0_2d_fix
                                        ...
                                        */
  real_T R1_2d[36];                    /* Variable: R1_2d
...
extern P_single_cell_battery_phaseC__T single_cell_battery_phaseC_ba_P;

/* Block signals (default storage) */
extern B_single_cell_battery_phaseC__T single_cell_battery_phaseC_ba_B;

/* Block states (default storage) */
extern DW_single_cell_battery_phaseC_T single_cell_battery_phaseC_b_DW;

/* Model entry point functions */
extern void single_cell_battery_phaseC_backup_initialize(void);
extern void single_cell_battery_phaseC_backup_step(void);
extern void single_cell_battery_phaseC_backup_terminate(void);

/* Real-time Model object */
extern RT_MODEL_single_cell_battery__T *const single_cell_battery_phaseC_b_M;
