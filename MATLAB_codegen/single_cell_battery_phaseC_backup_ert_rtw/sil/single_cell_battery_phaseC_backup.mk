...
## Generated on : Wed Apr 15 18:48:57 2026
## Final product: .\single_cell_battery_phaseC_backup.exe
...
MODELREF_LINK_RSPFILE     = single_cell_battery_phaseC_backup_ref.rsp
...
PRODUCT = .\single_cell_battery_phaseC_backup.exe
...
MODELREF_LIBS = ..\single_cell_battery_phaseC_backup.obj

LIBS = $(START_DIR)\slprj\ert\_sharedutils\rtwshared.lib $(START_DIR)\single_cell_battery_phaseC_backup_ert_rtw\coderassumptions\lib\single_cell_battery_phaseC_backup_ca.lib
...
xil_interface.obj : "$(START_DIR)\single_cell_battery_phaseC_backup_ert_rtw\sil\xil_interface.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\single_cell_battery_phaseC_backup_ert_rtw\sil\xil_interface.c"


sil_main.obj : "$(START_DIR)\single_cell_battery_phaseC_backup_ert_rtw\sil\sil_main.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\single_cell_battery_phaseC_backup_ert_rtw\sil\sil_main.c"
