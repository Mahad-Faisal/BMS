###########################################################################
## Makefile generated for component 'single_cell_battery'. 
## 
## Makefile     : single_cell_battery.mk
## Generated on : Tue Apr 14 22:13:47 2026
## Final product: $(RELATIVE_PATH_TO_ANCHOR)\single_cell_battery.exe
...
PRODUCT_NAME              = single_cell_battery
MAKEFILE                  = single_cell_battery.mk
...
COMPILER_COMMAND_FILE     = single_cell_battery_comp.rsp
CMD_FILE                  = single_cell_battery.rsp
C_STANDARD_OPTS           = 
CPP_STANDARD_OPTS         = 
NODEBUG                   = 1
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)\single_cell_battery.exe
...
DEFINES_STANDARD = -DMODEL=single_cell_battery -DNUMST=2 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(MATLAB_ROOT)\rtw\c\src\rt_logging.c $(START_DIR)\single_cell_battery_grt_rtw\rt_nonfinite.c $(START_DIR)\single_cell_battery_grt_rtw\single_cell_battery.c $(START_DIR)\single_cell_battery_grt_rtw\single_cell_battery_data.c
...
OBJS = rt_logging.obj rt_nonfinite.obj single_cell_battery.obj single_cell_battery_data.obj
...
{$(START_DIR)\single_cell_battery_grt_rtw}.c.obj:
	$(CC) $(CFLAGS) -Fo"$@" "$<"


{$(START_DIR)\single_cell_battery_grt_rtw}.cpp.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\single_cell_battery_grt_rtw}.cc.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"


{$(START_DIR)\single_cell_battery_grt_rtw}.cxx.obj:
	$(CPP) $(CPPFLAGS) -Fo"$@" "$<"
...
rt_nonfinite.obj : "$(START_DIR)\single_cell_battery_grt_rtw\rt_nonfinite.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\single_cell_battery_grt_rtw\rt_nonfinite.c"


single_cell_battery.obj : "$(START_DIR)\single_cell_battery_grt_rtw\single_cell_battery.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\single_cell_battery_grt_rtw\single_cell_battery.c"


single_cell_battery_data.obj : "$(START_DIR)\single_cell_battery_grt_rtw\single_cell_battery_data.c"
	$(CC) $(CFLAGS) -Fo"$@" "$(START_DIR)\single_cell_battery_grt_rtw\single_cell_battery_data.c"
